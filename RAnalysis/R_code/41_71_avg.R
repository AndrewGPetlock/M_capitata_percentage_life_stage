...
STx_y_avg <- CP[7:12,c(4,18:22)]  #grabbing rows 1-6 of CP, taking columns 4 (treatment) and 18-22 (lifestages 1 - 8p) of CP 
...
p5 <- p5 + ggtitle("M.Capitata embryo life stages in 41*71 cross (%)") #adding tittle
